...
cat "SAA-ID-001_Notarieel_Boedelinventarissen.xml" | python -m xmltodict 2 | python -u xml2rdf.py
...
<http://goldenagents.org/datasets/NotarialActs001> {
"""
